...
app.get(
	"/data-hewan/:nama/form-jadwal-makan",
	isAuthenticated,
	async (req, res) => {
		if (req.session.user) {
...
app.get(
	"/data-hewan/:nama/list-jadwal-makan",
	isAuthenticated,
	async (req, res) => {
		try {
...
app.post(
	...
	async (req, res) => {
		...
		try {
			...
			dataHewan.jadwalMakan.push({
				hariMakan: hariMakan,
				waktuMakan: waktuMakan,
				tanggalMakan: tanggalMakan,
			});
...
// Form jadwal vaksin
app.get(
	"/data-hewan/:nama/form-jadwal-vaksin",
	isAuthenticated,
	async (req, res) => {
		if (req.session.user) {
			const { nama } = req.params;
...
app.post(
	...
	async (req, res) => {
		...
		try {
			...
			dataHewan.tiketVaksin.push({
				waktuVaksin: waktuVaksin,
